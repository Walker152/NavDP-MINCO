...
class NavDPMincoAdapter:
        ...
        for env_idx in range(batch_size):
            ...
            for rank, selected_idx in enumerate(candidate_indices):
                ...
                candidate_timings.append({
                    ...
                    "objective_terms": dict(result.get("penalty_terms", {})),
            ...
            if best is not None:
                ...
                result = {
                    ...
                    "objective_terms": dict(best.get("penalty_terms", {})),
                    ...
                    **raw_metrics,
                    ...
                    "actual_speed_p95_mps": temporal_metrics["actual_speed_p95_mps"],
                    "actual_speed_max_mps": temporal_metrics["actual_speed_max_mps"],
                    "actual_acc_rms_mps2": temporal_metrics["actual_acc_rms_mps2"],
                    "actual_acc_p95_mps2": temporal_metrics["actual_acc_p95_mps2"],
                    "actual_acc_max_mps2": temporal_metrics["actual_acc_max_mps2"],
                    "actual_jerk_rms_mps3": temporal_metrics["actual_jerk_rms_mps3"],
                    "actual_jerk_p95_mps3": temporal_metrics["actual_jerk_p95_mps3"],
                    "actual_jerk_max_mps3": temporal_metrics["actual_jerk_max_mps3"],
                    "actual_yaw_rate_rms_radps": temporal_metrics["actual_yaw_rate_rms_radps"],
                    "actual_yaw_rate_max_radps": temporal_metrics["actual_yaw_rate_max_radps"],
                    "trajectory_duration_s": temporal_metrics["trajectory_duration_s"],
    ...
    def _fallback_result(
        ...
        result = {
            ...
            "objective_terms": dict(last_attempt.get("objective_terms", {})),
            "min_esdf": float("nan"),
