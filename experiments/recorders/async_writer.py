...
class AsyncRecordWriter:
    def __init__(self, output_dir: Path, schemas: dict[str, list[str]], flush_rows: int = 256, queue_size: int = 8192):
            ...
            while True:
                ...
                try:
                    ...
                    if kind == "csv":
                        ...
                        if self._counts[name] % self.flush_rows == 0: self._handles[name].flush()
                    else:
