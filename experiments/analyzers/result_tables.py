...
def generate_result_tables(suite_dir, episode_count=None, plan_count=None):
    ...
    definitions = {
        ...
        "table_smoothness": (plans, [("raw_curvature_tv_1pm","raw_curvature_tv_1pm","continuous"), ("equivalent_jerk_rms_mps3","actual_jerk_rms_mps3","continuous"), ("yaw_rate_rms_radps","actual_yaw_rate_rms_radps","continuous")]),
