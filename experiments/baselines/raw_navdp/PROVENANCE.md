...
Defaults are N=15, desired/v/w limits=0.5, ref_gap=3, T=0.1, dense ratio=50, Q=(10,10,0), R=(.02,.15). The adapter copies only coordinate transformation, reference selection and episode metric formulas. RAW remains NavDP Top-1 plus the original constant-speed MPC; it never uses the MINCO MPC.
